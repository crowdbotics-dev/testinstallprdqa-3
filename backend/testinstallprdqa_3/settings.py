"""
Django settings for testinstallprdqa_3 project.
...
ROOT_URLCONF = 'testinstallprdqa_3.urls'
...
WSGI_APPLICATION = 'testinstallprdqa_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testinstallprdqa_3 API",
    "DESCRIPTION": "API documentation for testinstallprdqa_3 App",
    "VERSION": "v1",
}
